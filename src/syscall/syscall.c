...
inline long syscall0(long number) {
  ...
  register long _number __asm__("x16") = (number);
#elif defined(__linux__)
  register long _number __asm__("x8") = (number);
#endif
  __asm__ volatile("svc 0\n" : "=r"(ret) : "r"(_number) : "memory", "cc");
...
inline long syscall3(long number, long arg1, long arg2, long arg3) {
  ...
  __asm__ volatile("svc 0\n"
                   : "=r"(ret)
                   : "r"(_arg1), "r"(_arg2), "r"(_arg3), "r"(_number)
                   : "memory", "cc");
